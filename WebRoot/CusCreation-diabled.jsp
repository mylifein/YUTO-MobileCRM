							...
							<form class="form-horizontal" action="${path}/cus/creation.do" method="post">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" id="chargeSman" name="chargeSman" class="form-control" value="${sessionScope.clerkName }" disabled>
                              				<input type="hidden" id="clerkMark" name="clerkMark" >	
                              ...
                              <!-- start of right column-->
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="cusTelephone" name="cusTelephone" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                </div>

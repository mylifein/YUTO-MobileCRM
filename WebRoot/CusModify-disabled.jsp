...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="${path}/js/bootstrap-3.3.7-dist/css/bootstrap.min.css" rel="stylesheet">
		...
		<div class="content container">
			<div class="row">
				<div class="col-sm-offset-1 col-sm-10">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2 class="panel-title">公司客户修改</h2>
						</div>
						<div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <fieldset disabled>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="customerCategory" name="customerCategory" class="form-control" placeholder="线索客户" >
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset disabled>
                                         <div class="form-group"> 
                                             ...
                                             <div class="col-sm-9">
                                                 <input type="text" id="customerNo" name="customerNo" class="form-control" value="${cust.cusMark }" disabled>
                                             </div>                                                         
                                         </div>
                                    </fieldset>
                                    <div class="form-group">
                              ...
                              <!-- start of right column-->
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="postCode" name="postCode" class="form-control" ${cust.postCode }>
                                        </div>    
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="panel-heading">
							         <button type="submit" class="btn btn-default pull-left" >修改</button>
						        </div>                                       
                            </form>
